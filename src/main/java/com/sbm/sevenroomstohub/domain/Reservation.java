...
public class Reservation implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "reservation" }, allowSetters = true)
    private Set<TableNum> tableNums = new HashSet<>();
    ...
    public Set<TableNum> getTableNums() {
        return this.tableNums;
    }

    public void setTableNums(Set<TableNum> tableNums) {
        if (this.tableNums != null) {
            this.tableNums.forEach(i -> i.setReservation(null));
        }
        if (tableNums != null) {
            tableNums.forEach(i -> i.setReservation(this));
        }
        this.tableNums = tableNums;
    }

    public Reservation tableNums(Set<TableNum> tableNums) {
        this.setTableNums(tableNums);
        return this;
    }

    public Reservation addTableNum(TableNum tableNum) {
        this.tableNums.add(tableNum);
        tableNum.setReservation(this);
        return this;
    }

    public Reservation removeTableNum(TableNum tableNum) {
        this.tableNums.remove(tableNum);
        tableNum.setReservation(null);
        return this;
    }
