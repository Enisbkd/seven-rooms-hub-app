    ...
    <div class="col-8">
      <div v-if="jobHistory">
        <h2 class="jh-entity-heading" data-cy="jobHistoryDetailsHeading">
          <span v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.detail.title')"></span> {{ jobHistory.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-text="t$('sevenRoomsToHubApplicationApp.Language.' + jobHistory.language)"></span>
          </dd>
          <dt>
