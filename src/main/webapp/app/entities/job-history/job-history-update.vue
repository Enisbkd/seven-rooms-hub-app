  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="sevenRoomsToHubApplicationApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.startDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.endDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.language')"
            ...
            >
              <option
                ...
                v-bind:label="t$('sevenRoomsToHubApplicationApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.department')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('sevenRoomsToHubApplicationApp.jobHistory.employee')"
