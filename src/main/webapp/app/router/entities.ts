...
const TableNum = () => import('@/entities/table-num/table-num.vue');
const TableNumUpdate = () => import('@/entities/table-num/table-num-update.vue');
const TableNumDetails = () => import('@/entities/table-num/table-num-details.vue');
...
export default {
  ...
  children: [
    ...
    },
    {
      path: 'table-num/new',
      name: 'TableNumCreate',
      component: TableNumUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'table-num/:tableNumId/edit',
      name: 'TableNumEdit',
      component: TableNumUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'table-num/:tableNumId/view',
      name: 'TableNumView',
      component: TableNumDetails,
      meta: { authorities: [Authority.USER] },
    },
