...
class TableNumberResourceIT {
    ...
    void createTableNumber() throws Exception {
        ...
        restTableNumberMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tableNumber)))
    ...
    void putExistingTableNumber() throws Exception {
        ...
        restTableNumberMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTableNumber.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedTableNumber))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingTableNumber() throws Exception {
        ...
        restTableNumberMockMvc
            .perform(
                put(ENTITY_API_URL_ID, tableNumber.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(tableNumber))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamTableNumber() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTableNumberMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tableNumber)))
    ...
    void patchNonExistingTableNumber() throws Exception {
        ...
        restTableNumberMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, tableNumber.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(tableNumber))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamTableNumber() throws Exception {
        ...
        restTableNumberMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(tableNumber))
            )
            .andExpect(status().isMethodNotAllowed());
